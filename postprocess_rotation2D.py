...
df = pd.read_csv("experiment_rotation2D_distr.csv")
if not os.path.exists("/home/s3202844/results/experiment_rotation2D/"):
    os.mkdir("/home/s3202844/results/experiment_rotation2D/")
os.chdir("/home/s3202844/results/experiment_rotation2D/")
